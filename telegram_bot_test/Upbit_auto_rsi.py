...
#목표 수익 0.5%!
target_rate = 0.005 # 0.5%.. 전략에 맞게 조절 하세용~
...
#파일 경로입니다.
dolpha_type_file_path = "/var/autobot/UpbitRSIDolPaCoin.json"
try:
        ...
        if myUpbit.CheckCoinInList(TopCoinList,ticker) == True or myUpbit.CheckCoinInList(DolPaCoinList,ticker) == True:
            ...
            if myUpbit.CheckCoinInList(DolPaCoinList,ticker) == True:
                ...
                if myUpbit.IsHasCoin(balances, ticker) == True:
                    ...
                    line_alert.SendMessage("RSI Divergence End!!!!! : " + ticker )
            ...
            #아직 전략에 의해 매수되지 않음
                ...
                if min % 15 == 0:
                    ...
                    #RSI 하락 추세선은 up_first_value < up_second_value
                    ...
                    if down_first_point != 0 and down_second_point != 0:
                        ...
                        if df['close'][-(down_first_point)] >= df['close'][-(down_second_point)]:
                    ...
                    if IsLongDivergence == True:
                        ...
                        if len(DolPaCoinList) < MaxCoinCnt and myUpbit.IsHasCoin(balances, ticker) == False:
                            ...
                            line_alert.SendMessage("!!!Divergence Buy Coin!!! : " + ticker + " --> " + str(up_first_point) + " " + str(up_second_point) )
