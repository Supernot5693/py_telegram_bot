...
# RSI 훌륭한 지표 안내 감사드립니다.
# 제 다른 의견은 변동성 부분인데요 (물론 RSI 자체도 변동성입니다만)

# 1. 이평선 5일 값보다 올라갈 경우 or
# 2. 실시간 가격 > ((당일시가+(전일고가-전일저가) * 0.05)

# 이 경우도 가파른 상승세로 볼 수 있다고 알고 있습니다 ^^ 그런데 RSI 14일 지표보다 사는 날이 더 적을 수 있습니다.

# 그리고 전에도 말씀 드렸는데 게민아님은 정말 좋은 성품을 가지고 계시네요.
# 제가 교육 쪽에 종사하고 있는데 게민아님의 타인을 향한 배려가 강의 구석구석 자연스럽게 나오는 것을 매 번 느낍니다.
# 타인을 도와주려고 하는 마음, 진정성도 많이 느껴지고요, 이 강의가 단순한 유료 강의가 아님을 느낍니다.

# 사람들의 댓글, 반복적인 질문 (내가 다 올렸는데 또 올려야 되나, 내 블로그 안 보나 다른 사람 댓글 안 보나 또 남겨야 되나)
# 이런 부분에 대해서도 최대한 친절하게 남기시는 모습에 감탄을 금치 못합니다.

# 정말 대단하신 분이세요. 저랑 나이가 거의 동갑인데 더 많이 겸손해져야겠다는 생각이 많이 듭니다.
